...
// 아이콘 사용을 위해 @expo/vector-icons의 Ionicons를 임포트합니다.
...
function FilterGroup() {
    ...
    return (
        // <div className="filter-group-container"> -> View로 변환
...
const filterGroupStyles = StyleSheet.create({
    ...
    // --- FilterButton Styles (FilterButton.css 참고) ---
    filterButton: {
        flexDirection: 'row',
        alignItems: 'center',
        paddingVertical: 10,
